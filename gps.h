...
#define GPS_REOPEN_TIME 2 // in second
...
extern char parsed_gps_info[BUFLEN];

extern char time_v[TIMELEN], lat_v[LATITUDELEN], lon_v[LONGITUDELEN];
extern char direction_v[8];
extern float speed_v;

extern pthread_mutex_t get_can_info_lock;
extern char get_can_info[BUFLEN];

extern pthread_mutex_t vsm_sendbuf_lock;
extern char vsm_sendbuf[BUFLEN];

extern pthread_mutex_t CD_sendbuf_lock;
extern char CD_sendbuf[BUFLEN]; // Control & Display module's private data

extern sem_t gps_full_sem;
extern sem_t gps_empty_sem;
extern sem_t can_full_sem;
extern sem_t can_empty_sem;
extern sem_t vsm_full_sem;
extern sem_t vsm_empty_sem;
extern sem_t CD_full_sem;
extern sem_t CD_empty_sem;
 ...
 */
// CTRL_DISP_PORT located in PC or any device else which used for controlling OBU and displaying info. Default value.
#define CTRL_DISP_PORT 40000
// Control & Display module's default IPv4 address
...
extern char ctrl_disp_addr[INET_ADDRSTRLEN];
extern unsigned short ctrl_disp_port;
